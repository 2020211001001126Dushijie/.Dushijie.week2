			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							homework.modle.Order o=(homework.modle.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							homework.dao.Userdao userDao=new homework.dao.Userdao();
						...
						<%
							...
							String paymentType=homework.modle.Payment.findByPaymentId(con,n);
							 %>
