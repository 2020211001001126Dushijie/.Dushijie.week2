...
<%@taglib prefix="fn" uri="http://java.sum.com/jsp/jstl/funtions" %>
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<c:forEach var="p" items="${productList}">
						<tr>
							...
							<%
								homework.modle.Product p=(homework.modle.Product)pageContext.findAttribute("p");
								int pid=p.getProductId();
								java.sql.Connection con=(java.sql.Connection)application.getAttribute("con")
								String catName=homework.modle.Category.findByCategoryId(con,pid);
							%>
