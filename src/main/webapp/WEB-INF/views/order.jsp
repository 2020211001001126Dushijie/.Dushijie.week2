					...
					<!-- loop_start -->
						...
						<tr>
							<td class="cart_product">
								<a href="">
								<img src="getImg?id=${c.prodict.productId}" alt="" style="height: 150px; width: 150px"></a>
							</td>
							<td class="cart_description">
								<h4><a href="">${c.prodict.productName} </a></h4>
								<p>Web ID: ${c.prodict.productId} </p>
							</td>
							<td class="cart_price">
								<p>${c.prodict.price}</p>
							</td>
							<td class="cart_price">
								<p>${c.prodict.quantity}</p>
							</td>
							<td class="cart_total">
								<p id="total" class="cart_total_price">${c.prodict.price*c.quantity}</p>
							</td>
